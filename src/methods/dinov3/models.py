# Code from https://github.com/facebookresearch/dinov3/blob/main/dinov3/models/vision_transformer.py
...
def dino_head(in_dim, out_dim, use_bn=False, nlayers=3, hidden_dim=2048, bottleneck_dim=256, mlp_bias=True):
    head = DINOHead(
        in_dim=in_dim,
        out_dim=out_dim,
        use_bn=use_bn,
...
def vit_small(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
...
def vit_base(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=768,
        depth=12,
...
def vit_large(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=1024,
        depth=24,
...
def vit_so400m(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=1152,
        depth=27,
...
def vit_huge2(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=1280,
        depth=32,
...
def vit_giant2(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
    """
...
def vit_7b(patch_size=16, use_checkpoint=False, drop_path_rate=0.0):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=4096,
        depth=40,
